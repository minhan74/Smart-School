...
//#define TOUCH_MEASURE_CYCLE 0x1000
//#define TOUCH_SLEEP_CYCLE   0x1000
//bool touch = false;
...
void setup() {
 ...
 //touchSetCycles(TOUCH_MEASURE_CYCLE,TOUCH_SLEEP_CYCLE);
...
void loop() {
  ...
  digitalWrite(SOLENOID,LOW); //take advantages of the waiting time of the subcribe loop

  if((! mqtt.ping())&&((millis()-lastmillis)>60000)) { // ping the server to keep the mqtt connection alive
    lastmillis = millis(); //60second
    mqtt.disconnect();
    }//end if
}//end loop
/////////////////////////////////////////////////////////////////////////////////////////////
