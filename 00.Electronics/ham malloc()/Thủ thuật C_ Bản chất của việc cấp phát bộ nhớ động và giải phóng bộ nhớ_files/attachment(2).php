...
<!--
	...
	var RELPATH = "attachment.php?attachmentid=2211&amp;stc=1&amp;d=1267596805";
	var PATHS = {
	...
	<h2 class="blockhead">Cộng đồng C Việt thông báo</h2>
		...
		<form class="block vbform"  method="post" action="login.php?do=login" onsubmit="md5hash(vb_login_password, vb_login_md5password, vb_login_md5password_utf, 0)">	
			...
			<input type="hidden" name="securitytoken" value="guest" />			
					...
					<input type="hidden" name="url" value="http://diendan.congdongcviet.com/attachment.php?attachmentid=2211&amp;stc=1&amp;d=1267596805" />
...
<div id="footer" class="footer clearfix">
	...
	<ul id="footer_links" class="footer_links">
		...
		<li><a href="attachment.php?attachmentid=2211&amp;stc=1&amp;d=1267596805#top" onclick="document.location.hash='top'; return false;">Top</a></li>
	</ul>
